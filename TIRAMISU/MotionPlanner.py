...
class Node:
    ...
    def visit(self):
        ...
        for c in range(-1, 2):
            for r in range(-1, 2):
                if(EXISTENT_NODE_MAP[self.position_x+c][self.position_y+r] == 0 and Topographer.WALL_MAP[self.position_x+c][self.position_y+r] in (-1, 0) and Topographer.WALL_SPLASH_MAP[self.position_x+c][self.position_y+r] <= 0 and Topographer.LANDMARK_MAP[self.position_x+c][self.position_y+r] != 99):
